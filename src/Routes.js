...
import MaoDeObraList from '@/views/MaoDeObra/MaoDeObraList.vue'
import MaoDeObraCategoria from '@/views/MaoDeObra/MaoDeObraCategoria.vue'

import UtilizadorList from '@/views/Utilizadores/UtilizadorList.vue'

import DashboardMain from '@/views/Dashboard/Dashboard.vue'
  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        {
          path: 'maodeobra/list',
          name: 'Mao-de-obra-list',
          component: MaoDeObraList,
        },
        {
          path: 'maodeobra/categoria',
          name: 'Mao-de-obra-categoria',
          component: MaoDeObraCategoria,
        },

        {
          path: 'utilizador/list',
          name: 'Utilizadores-list',
          component: UtilizadorList,
        },
        {
          path: 'dashboard/main',
          name: 'Dashboard-main-list',
        ...
        {
          path: 'venda/recibo/add',
          name: 'recibo-add',
          component: ReciboAdd,
        },

        {
          path: 'venda/recibo/:reciboId',
          name: 'recibo-detalhes',
          component: ReciboDetalhes,
        },
        ////////////////////////////////////////////////////////////////////////////////
