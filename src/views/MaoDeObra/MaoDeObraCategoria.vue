<template>
  <b-row>
    <h1 class="page-title">
      Lista de <span class="fw-semi-bold">Categoria de Mãos-de-obra</span>
    </h1>
    <b-col lg="12">
      <Widget customHeader>
      ...
      >
        <b-form @submit.prevent="handleSubmit">
          ...
          <b-form-group label="Unidade" label-for="search-field" breakpoint="md">
            <v-select id="search-select" v-model="unidade" :options="['cm', 'pcs']" />
...
export default {
  ...
  methods: {
    saveData() {
      ...
      http
        .post("/categorias_mao_de_obra", data, config)
        .then((result) => {
          this.$swal({
            title: "Sucesso!",
